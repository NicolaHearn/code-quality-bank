...
describe('account', () => {
  describe('dates', () => {
    ...
    it('does not record a new transaction unless the date is valid', () => {
      ...
      expect(myAccount.transactions[0]).toEqual({"balance": 200, "credit_amount": 200, "date": new Date("2023", "2"-1, "1"), "debit_amount": null});
      expect(myAccount.withdraw(200, 12)).toEqual(false)
      expect(myAccount.transactions[1]).toEqual({"balance": 100, "credit_amount": null, "date": new Date("2023", "2"-1, "1"), "debit_amount": 100});
